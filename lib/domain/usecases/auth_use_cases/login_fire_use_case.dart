...
class LoginFireUseCase implements BaseUseCases<UserCredential,EmailAndPassEntryModel>{
 const LoginFireUseCase(this.baseAuthRepo);

  final BaseAuthRepo baseAuthRepo;

  @override
  Future<Either<Failure, UserCredential>> call(EmailAndPassEntryModel loginModel)async {
  return await baseAuthRepo.logUserIn(loginModel: loginModel);
  }
